...
\newcommand*{\name}[1]{\lhead{\sffamily #1}}
\newcommand*{\doctitle}[1]{\chead{\sffamily \large \bfseries #1}}
...
\DeclareRobustCommand{\ttfamily}{\oldttfamily\vsname ttsize\endcsname}
\def\ttsize{\small}
\newcommand{\code}[1]{\colorbox{light-gray}{\textttt{#1}}}
