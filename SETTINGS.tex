...
\usepackage[english]{babel} % type english
% \usepackage[ngerman]{babel} % type german
...
\lhead{\upshape Johann Birnick}
\chead{\upshape \large \bfseries \LaTeX{} (Math) Template}
\rhead{\upshape Page \thepage /\pageref*{LastPage}}
\lfoot{}
\cfoot{}
\rfoot{}
...
\input{SETTINGS_commands.tex}

% ENVIRONMENTS

\input{SETTINGS_environments.tex}